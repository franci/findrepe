...
public class BigRational extends Number implements Comparable<BigRational> 
{
    ...
    public static final BigRational TEN = BigRational.valueOf(10);
    ...
    {
        BigInteger gcd = BigMath.gcd(this.n, this.d);
    ...
    public int hashCode()
    {
        int hash = ( this.n.hashCode() ^ this.d.hashCode() );
        return hash;
    }
    ...
    public static BigRational build(BigDecimal value, int precision)
    {
        ...
        while( !cur.equals(value) && !cur.equals(pre))
        {
            pre = cur;
    ...
    //falta hacer el build con BigDecimal
